              ...
              <div>
                <div className="text-center space-y-2">
                  <div className="flex items-baseline justify-center text-gray-800">
                    <span className="font-bold text-3xl">$10,842</span>
                ...
                <div className="relative w-full h-4 bg-gray-200 rounded-full mt-4 overflow-hidden">
                  <div className="absolute top-0 left-0 h-full bg-primary rounded-full" style={{ width: "43.4%" }}></div>
                </div>
                <div className="text-right text-sm text-gray-600 mt-1">43.4%</div>
