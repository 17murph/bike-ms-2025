...
export const season3: Season = {
  ...
  episodes: [
    {
      id: "S3_E8",
      title: "Katie Heckert - Finding Strength in Vulnerability",
      guest: "Katie Heckert",
    ...
    {
      id: "S3_E7",
      title: "The Compassion You Don't Expect – with Dr. Deanna Greer",
      guest: "Dr. Dee",
    ...
    {
      id: "S3_E6",
      title: "Cori - Sometimes, MS Is a Lesson for the Ones Who Watch",
      guest: "Cori",
    ...
    {
      id: "S3_E4",
      title: "Pam Grimes: Strength, Stencils, and Showing Up Anyway",
      guest: "Pam Grimes",
      link: "https://open.spotify.com/episode/6yqxdnVWODQ26hUdbwn348?si=11eb71dccffe4b02",
      date: "Apr 07, 2025",
    },
    {
      id: "S3_E3",
      title: "Becca - Becca's Unfiltered Journey with MS",
      guest: "Becca",
      link: "https://open.spotify.com/episode/4UKicNgDubGAfj9EIKhUJL?si=cd5ffe6d492541a5",
      date: "Mar 31, 2025",
    },
    {
      id: "S3_E2",
    ...
    {
      id: "S3_E1",
      title: "Jasmine Hanna - Conquering Life with MS; from Diagnosis to Advocacy",
      guest: "Jasmine Hanna",
      link: "https://open.spotify.com/episode/2mgTM4aV6BRTA1mWFfd2FD?si=2ef53d2989f2481c",
      date: "Mar 17, 2025",
    },
  ],
}
