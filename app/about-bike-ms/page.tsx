                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 my-6">
                  ...
                  <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow flex flex-col h-full">
                    ...
                    <div className="p-4 flex flex-col flex-grow">
                      ...
                      <p className="text-sm text-gray-600">Rob is entering his nineteenth year with Bike MS and has completed twenty-seven events since first joining the movement in 2008. He serves on the Kentucky planning committee, where he focuses on growing rider participation through personal outreach and strong relationships with local bike shops. Rob rides for the many people in his life who live with MS, including more than two dozen names he carries on his bib each year. He also created Mowing for MS, mowing fifteen yards each season and donating the proceeds to the MS Society. To date, he has contributed more than thirty-nine thousand dollars through this effort. Rob is the team captain of Ford Warriors. His 2026 fundraising goal is $15,000.</p>
