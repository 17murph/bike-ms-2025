  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      <main className="relative">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/40 to-black/70 flex flex-col items-center justify-center text-white p-4">
            <div className="container mx-auto max-w-4xl px-4">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="text-xl md:text-2xl mb-10 leading-[1.5]" aria-hidden="true">&nbsp;</div>
        ...
        {/* Thin Orange Divider */}
        <section className="bg-orange-500 h-[2px]" aria-hidden="true"></section>
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 flex items-center justify-between gap-4">
              <div className="flex-1">
                ...
                <div className="flex items-baseline gap-1.5">
                  <span className="text-xl font-bold text-primary">$4,841</span>
                  <span className="text-gray-500 text-sm">of $9,000</span>
                </div>
